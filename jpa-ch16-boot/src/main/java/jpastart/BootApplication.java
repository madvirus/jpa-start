...
public class BootApplication {
    ...
    private void handleJoinCommand(String[] cmd) {
        if (cmd.length != 3) {
    ...
    private void handleChangeName(String[] cmd) {
        if (cmd.length != 3) {
            System.out.println("명령어가 올바르지 않습니다.");
    ...
    private void handleWithdrawCommand(String[] cmd) {
        if (cmd.length != 2) {
            System.out.println("명령어가 올바르지 않습니다.");
