...
public class UserMain {
    ...
    private static void handleViewCommand(String[] cmd) {
        ...
        GetUserService getUserService = ctx.getBean(GetUserService.class);
    ...
    private static void handleChangeName(String[] cmd) {
        ...
        try {
            ChangeNameService changeNameService = ctx.getBean(ChangeNameService.class);
    ...
    private static void handleListCommand() {
        GetUserListService listService = ctx.getBean(GetUserListService.class);
